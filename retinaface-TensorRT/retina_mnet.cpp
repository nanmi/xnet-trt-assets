...
ICudaEngine* createEngine(unsigned int maxBatchSize, IBuilder* builder, IBuilderConfig* config, DataType dt) {
    ...
    std::map<std::string, Weights> weightMap = loadWeights("../weights/mobilenet0.25_Final.wts");
    Weights emptywts{DataType::kFLOAT, nullptr, 0};
...
int main(int argc, char** argv) {
    ...
    size_t size{0};
    const char* engine_name = "../weights/mobilenet0.25_Final_640x640_fp16b1.engine";
    ...
    cv::Mat img = cv::imread("../img/worlds-largest-selfie.jpg");
